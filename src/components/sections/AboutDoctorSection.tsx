      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        >
          ...
          <p className="text-muted leading-relaxed mb-6">
            With over 5 years of clinical experience, Dr. Pawar Honey has dedicated her career to helping patients overcome pain and mobility issues. Her evidence-based approach and personalized care plans have successfully treated over 1,000+ patients.
          </p>
        ...
        >
          <div className="relative aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl">
            ...
            <div className="absolute bottom-8 left-8 text-white">
              <h4 className="text-2xl font-bold font-heading mb-1">Dr. Pawar Honey</h4>
              <p className="text-white/80">Expert Physiotherapist</p>
            </div>
          </div>
          {/* Decorative element */}
